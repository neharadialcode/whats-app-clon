      ...
      <div className="sidebar">
        ...
        <div className="search-bar d-flex justify-content-between align-items-center">
          ...
          <div className="search_input d-flex flex-grow-1 me-4">
            ...
            <input id="search" type="search" placeholder="Search or start new chat" className="w-100" />
          </div>
        ...
        <div className="chat-list">
          ...
          {Contacts.map((data, value) => {
            return (
              <div className="px-3 me-2 d-flex align-items-start pt-3 mt-2">
                <img src={userpic} alt="userdp" className="me-2" />

                <div className="d-flex border-bottom">
                  <div>
                    <p className="text_grey m-0 fe_medium fs_20">Daniel Kalio</p>
                    <p className="text_grey text-nowrap message_text">+2348128225157:
                      That’s a great news! Congratulations...</p>
                  </div>
                  <div>
                    <p className="text_grey fs_14 text-nowrap m-0">3:11 pm</p>
                    <p className="unread_msg m-0 d-flex align-items-center justify-content-center">115</p>
                  </div>
                </div>
              </div>
            );
      ...
      <div className="main-content">
        <div className="chat-header">
          <div className="contact-info d-flex align-items-center ">
            ...
            <img src={userpic} alt="" />
            <p className="text_grey m-0 ps-2 fe_medium fs_20">Daniel Kalio</p>
          </div>
        ...
        <div className="chat-messages">
          ...
          <h1>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reiciendis dolores quisquam maxime blanditiis magnam cupiditate adipisci expedita numquam repudiandae, dolorem, ut, officia amet ipsa perspiciatis delectus a? Doloremque rem quaerat similique asperiores, ipsa nemo aliquam totam ipsum nesciunt molestiae eius sequi architecto at inventore, temporibus ducimus eum dolore, earum autem suscipit. Ratione, excepturi officia. Asperiores commodi repudiandae quas tempore. Amet, sunt. Asperiores vel quae quidem molestiae corporis! Quasi commodi, alias rem voluptatem repellat incidunt voluptates iure consequatur accusantium molestias ut iusto dignissimos minus minima expedita dolor officia distinctio voluptatum culpa explicabo dolore esse nisi? Quia, earum! Nostrum numquam dolorum laborum nesciunt maxime odio possimus error quasi natus voluptatem expedita neque aperiam consequuntur, rem nulla praesentium necessitatibus quam beatae vitae provident distinctio debitis! Debitis suscipit natus facere tempora ea reprehenderit placeat eaque necessitatibus deserunt, magnam aperiam at ratione adipisci unde quis facilis voluptatibus quia illum? Temporibus a, sed neque voluptatibus corporis in pariatur eveniet accusantium nobis reiciendis nihil velit laboriosam molestiae praesentium quod cumque culpa, at numquam quidem explicabo libero magnam mollitia quia consequuntur. Vitae magnam mollitia, quas nostrum reiciendis cupiditate similique totam non? Dolore hic recusandae, quam necessitatibus ipsa delectus minus! Eligendi ipsum officia animi nam, unde provident consectetur iusto beatae ab facilis amet mollitia enim ad nobis ipsam error quos commodi asperiores aliquam molestias nisi repellendus voluptates? Beatae voluptatum laudantium natus debitis non placeat quaerat accusantium possimus? Officia asperiores ratione error unde aspernatur vitae harum voluptate dolorem. Quasi quos autem non eos, pariatur assumenda delectus ullam illo recusandae laborum.</h1>
        </div>
...
<path d="M20 4H16.83L15.59 2.65C15.4036 2.44539 15.1767 2.28191 14.9235 2.16999C14.6704 2.05807 14.3968 2.00017 14.12 2H9.88C9.32 2 8.78 2.24 8.4 2.65L7.17 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17Z" fill="#6B7C85"/>
            ...
            <input id="message" type="search" placeholder="Type a message" className="w-100" />
          </div>
